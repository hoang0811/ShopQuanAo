...
Route::delete('/cart/clear',[CartController::class,'empty_card'])->name('cart.empty');

Route::post('/cart/wishlist',[WishlistController::class,'add_to_wishlist'])->name('wishlist.add');
Route::get('/wishlist',[WishlistController::class,'index'])->name('wishlist.index');
Route::delete('/wishlist/remove/{rowId}', [WishlistController::class, 'remove_wishlist'])->name('wishlist.remove');
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/account-addresses/setDefault/{id}', [UserController::class, 'address_default'])->name('address.default');
    Route::delete('/account-addresses/delete/{id}',[UserController::class,'address_remove'])->name('address.delete');
});
...
Route::middleware(['auth',AuthAdmin::class])->group(function(){
    ...
    Route::put('/admin/prodcut/update',[AdminController::class,'product_update'])->name('admin.product.update');
    ...
    Route::delete('/admin/coupon/{id}/coupon',[AdminController::class,'coupon_delete'])->name('admin.coupon.delete');
