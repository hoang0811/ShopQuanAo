        ...
        <section class="my-account container">
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    @if($order->status =="ordered" && $transaction->status != "approved")
                    <div class="wg-box mt-5 text-right">
                        <form action="{{route('user.order.cancel')}}" method="POST">
                            ...
                            <input type="hidden" name="_method" value="PUT"> <input type="hidden" name="order_id"
                                value="{{$order->id}}">
                            <button type="submit" class="btn btn-danger delete">Cancel Order</button>
                        </form>
                    </div>
                    @endif
                </div>
    ...
    <script>
        $(function() {
            $('.delete').on('click', function(e) {
                ...
                swal({
                    title: "Are you sure ?",
                    text: "You want to delete thos record",
                    type: "warning",
                    buttons: ["No", "YES"],
