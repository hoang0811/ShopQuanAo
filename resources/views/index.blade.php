...
@section('content')
    <main>
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <section class="products-grid container">
                ...
                <!-- Mở một row duy nhất để chứa tất cả sản phẩm -->
                <div class="row">
                                        ...
                                        <div class="swiper-slide product-card product-card_style3">
                                            ...
                                            <div class="pc__info position-relative">
                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span
                                                        class="money price price-old">${{ $sproduct->regular_price }}</span>
                                                    <span
                                                        class="money price price-sale">${{ $sproduct->sale_price }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
    ...
    sliders.forEach(slider => {
        ...
        new Swiper(slider, {
            ...settings,
            autoplay: settings.autoplay || false // Đảm bảo autoplay được bật
        });
    });
});
