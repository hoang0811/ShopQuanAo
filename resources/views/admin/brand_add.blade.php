            ...
            <div class="main-content-wrap">
                ...
                <div class="wg-box">
                    <form class="form-new-product form-style-1" action="{{route('admin.brand.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        @error('name')
                            <span class="alert alert-dager text-center">{{$message}} </span>
                        @enderror
                        <fieldset class="name">
                            <div class="body-title">Brand Slug <span class="tf-color-1">*</span>
                            </div>
    ...
    <script>
        $(function(){
            ...
            $("input[name='name']").on("change",function(){
                $("input[name='slug']").val(StringToLug($(this).val()));
            });
        });
        function StringToLug(Text)
        {
