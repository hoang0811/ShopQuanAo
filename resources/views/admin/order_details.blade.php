...
@section('content')
    <div class="main-content">
        ...
        <style>
            ...
            .shipping-address .address-detail p {
                margin: 5px 0;
                font-size: 14px;
            }

            .shipping-address .address-detail p strong {
                font-weight: 600;
                color: #333;
            }
        ...
        <div class="main-content-inner">
            <div class="main-content-wrap">
                ...
                <div class="wg-box  mt-5">
                    ...
                    <form action="{{ route('admin.order.status.update') }}" method="post" style="display: flex; align-items: center;">
                        @csrf
                        @method('PUT')
